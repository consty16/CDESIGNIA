        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 mb-12 max-w-[450px]">
            <button
              ...
              className="w-full h-full flex items-center justify-center border text-white py-3 px-2 sm:px-4 text-[10px] sm:text-xs uppercase tracking-widest hover:brightness-125 transition-all rounded font-bold text-center border-[#c2abed] shadow-[0_0_20px_rgba(194,171,237,0.5),0_0_35px_rgba(194,171,237,0.2),inset_0_0_10px_rgba(194,171,237,0.2)]"
            >
              Portfolio
            </button>
            <a
            ...
            >
              <button
                ...
                className="w-full h-full flex items-center justify-center gap-2 border text-white py-3 px-2 sm:px-4 text-[10px] sm:text-xs uppercase tracking-widest hover:brightness-125 transition-all rounded font-bold text-center border-[#c2abed] shadow-[0_0_20px_rgba(194,171,237,0.5),0_0_35px_rgba(194,171,237,0.2),inset_0_0_10px_rgba(194,171,237,0.2)]"
              >
                Projects
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full h-full flex items-center justify-center gap-2 border text-white py-3 px-2 sm:px-4 text-[10px] sm:text-xs uppercase tracking-widest font-bold hover:brightness-125 transition-all duration-300 rounded text-center border-[#c2abed] shadow-[0_0_25px_rgba(194,171,237,0.7),0_0_50px_rgba(194,171,237,0.3),inset_0_0_12px_rgba(194,171,237,0.4)]"
            >
