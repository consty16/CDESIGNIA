        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 mb-12 max-w-[450px]">
            <button
              ...
              style={{ borderColor: '#c2abed', boxShadow: '0 0 20px rgba(194,171,237,0.5), 0 0 35px rgba(194,171,237,0.2), inset 0 0 10px rgba(194,171,237,0.2)' }}
            >
              Portfolio
            </button>
            <a
            ...
            <a
              ...
              style={{ borderColor: '#c2abed', boxShadow: '0 0 35px rgba(194,171,237,0.8), 0 0 70px rgba(194,171,237,0.4), inset 0 0 15px rgba(194,171,237,0.4)' }}
            >
