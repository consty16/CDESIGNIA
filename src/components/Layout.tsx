        ...
        >
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <button
              ...
              className="bg-gradient-to-br from-[#3b0f6b] to-[#240842] text-lilac w-48 h-14 text-[14px] uppercase tracking-widest font-bold hover:brightness-125 transition-all rounded shadow-[0_0_40px_rgba(168,85,247,0.6)] hover:scale-105 flex items-center justify-center border border-lilac/30"
            >
              Portfolio
            </button>
            <a
              href="#about"
              className="bg-gradient-to-br from-[#3b0f6b] to-[#240842] text-lilac w-48 h-14 text-[14px] uppercase tracking-widest font-bold hover:brightness-125 transition-all rounded shadow-[0_0_40px_rgba(168,85,247,0.6)] flex items-center justify-center border border-lilac/30"
            >
              Quiénes somos
            </a>
            <div 
