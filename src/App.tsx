  ...
  return (
    <main className="bg-bg min-h-screen selection:bg-lilac-neon/30 selection:text-lilac-glow">
      ...
      <button
        ...
        className="fixed bottom-8 right-8 z-[400] w-16 h-16 rounded-full flex items-center justify-center hover:scale-110 transition-transform group shadow-[0_0_20px_rgba(194,171,237,0.5)]"
